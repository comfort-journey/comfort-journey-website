...
const FLIGHT_ROUTES = [
  {
    ...
    destination: 'Dharamshala & Dalhousie, India',
    coords: { x: 260, y: 70 },
    ...
    description: 'Tibetan monasteries, McLeod Ganj markets, Khajjiar alpine meadows & luxury pine retreats.',
  },
  {
    id: 'europe',
    name: 'Essence of Europe: Rome, Milan & Zurich',
    destination: 'Rome, Milan, Ferrara & Zurich',
    coords: { x: 120, y: 110 },
    ...
    description: 'High-speed scenic rail across Italy and the Swiss Alps, historic cathedrals & alpine lake cruises.',
  },
  {
    id: 'bali',
    name: 'Bali Tropical Escape: Ubud & Seminyak',
  ...
  {
    id: 'dubai',
    name: 'Dubai City & Sands: Skyline & Red Dunes',
    ...
    description: 'Burj Khalifa VIP lounge, vintage Land Rover desert safari, private yacht & luxury shopping.',
  },
  {
    id: 'phuket',
    name: 'Phuket Paradise Getaway & Phi Phi',
    destination: 'Phuket & Krabi, Thailand',
    coords: { x: 350, y: 210 },
    curveCtrl: { x: 300, y: 190 },
    color: '#6FE6FC',
    price: 71047,
    duration: '6 Days / 5 Nights',
    rating: 4.96,
    tag: '🏝️ Tropical Island',
    image: 'https://images.unsplash.com/photo-1506665531195-3566af2b4dfa?auto=format&fit=crop&w=600&q=80',
    description: 'Speedboat cruise to Maya Bay, snorkeling at Phi Phi Islands, clifftop beachfront resort.',
  }
];
