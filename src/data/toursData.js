...
export const TESTIMONIALS = [
  {
    ...
    comment: "Comfort Journey made our Kashmir honeymoon completely unforgettable! The luxury houseboat stay on Dal Lake and Gulmarg Gondola Phase 2 tickets were managed effortlessly. Sharad ji and Rishabh ji took care of every single detail.",
    rating: 5,
  ...
  },
  {
    ...
    tour: "Swiss Alpine & Titlis Glacier Pass",
    rating: 5,
    comment: "Flawless Swiss itinerary with 1st Class Swiss Rail Passes. Mt. Titlis cable car, Interlaken chalets, and Jungfraujoch Top of Europe were arranged seamlessly. 24/7 WhatsApp concierge was responsive even with time difference.",
    avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=150&q=80"
  },
  {
    name: "Pradeep Sharma",
    location: "Delhi NCR",
    tour: "Sacred Char Dham Yatra",
    rating: 5,
    comment: "Took my elderly parents for Char Dham Yatra. Comfort Journey arranged priority VIP darshan and comfortable heated hotels at high altitude. Truly blessed experience with total safety.",
